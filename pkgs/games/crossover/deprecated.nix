{
  ...
  steam-run-custom =
    (steam.override {
      ...
      extraLibraries = pkgs: with pkgs; [gnutls openldap gmp openssl libunwind sane-backends libgphoto2 openal apulse libpcap ocl-icd libxcrypt-legacy nssmdns] ++ extraLibs pkgs;
      extraProfile = ''
